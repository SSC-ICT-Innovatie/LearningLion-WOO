...
python evaluate_embeddings.py --evaluation_file minbzk.json --embedding_model GroNLP/bert-base-dutch-cased --collection_name minbzk_no_requests_real_words --vector_db_folder final_vector_stores/minbzk_no_requests_chromadb_1024_256_GroNLP/bert-base-dutch-cased --results_path final_evaluation_minbzk/results --evaluation_directory ./final_evaluation_minbzk
python evaluate_embeddings.py --evaluation_file minbzk_paraphrase.json --embedding_model GroNLP/bert-base-dutch-cased --collection_name minbzk_no_requests_real_words --vector_db_folder final_vector_stores/minbzk_no_requests_chromadb_1024_256_GroNLP/bert-base-dutch-cased --results_path final_evaluation_minbzk/results --evaluation_directory ./final_evaluation_minbzk
python evaluate_embeddings.py --evaluation_file minbzk_keywords.json --embedding_model GroNLP/bert-base-dutch-cased --collection_name minbzk_no_requests_real_words --vector_db_folder final_vector_stores/minbzk_no_requests_chromadb_1024_256_GroNLP/bert-base-dutch-cased --results_path final_evaluation_minbzk/results --evaluation_directory ./final_evaluation_minbzk
python evaluate_embeddings.py --evaluation_file minbzk_real_words.json --embedding_model GroNLP/bert-base-dutch-cased --collection_name minbzk_no_requests_real_words --vector_db_folder final_vector_stores/minbzk_no_requests_chromadb_1024_256_GroNLP/bert-base-dutch-cased --results_path final_evaluation_minbzk/results --evaluation_directory ./final_evaluation_minbzk
"""
