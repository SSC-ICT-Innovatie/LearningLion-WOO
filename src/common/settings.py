...
EMBEDDINGS_MODEL = "GroNLP/bert-base-dutch-cased"
...
GENERATION_METHOD = "document_only"

# This is a standard set of instructions the LLM will be given. You can update this through trial and error for your use case in the most optimal way.
SYSTEM_PROMPT = """
### OBJECTIVE ###
