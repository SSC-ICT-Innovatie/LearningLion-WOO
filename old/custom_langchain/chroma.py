...
class Chroma(VectorStore):
    ...
    def similarity_search_by_vector(
        ...
        **kwargs: Any,
        ...
        Args:
            embedding (List[float]): Embedding to look up similarity_search_with_score similar to.
    ...
    # Took this function from langchain_core.vectorstores.VectorStore and adjusted it
